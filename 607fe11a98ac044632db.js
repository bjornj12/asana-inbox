...
/***/ function(module, exports, __webpack_require__) {
	...
	var _johannth$what_to_read_next$LocalStorage$decodeToType = F2(
		function (item, decoder) {
			var _p0 = item.value;
			if (_p0.ctor === 'Just') {
				return _elm_lang$core$Result$toMaybe(
					A2(_elm_lang$core$Json_Decode$decodeString, decoder, _p0._0));
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		});
	...
	var _johannth$what_to_read_next$LocalStorage$getItem = _elm_lang$core$Native_Platform.outgoingPort(
		'getItem',
		function (v) {
			return v;
		});
	var _johannth$what_to_read_next$LocalStorage$receiveItem = _elm_lang$core$Native_Platform.incomingPort(
		'receiveItem',
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (key) {
	...
	var _johannth$what_to_read_next$LocalStorage$LocalStorageItem = F2(
		function (a, b) {
	...
	var _johannth$what_to_read_next$Types$assigneeStatusFromDropTarget = function (dropTarget) {
		var _p0 = dropTarget;
		switch (_p0.ctor) {
			case 'Before':
				return _p0._0;
	...
	var _johannth$what_to_read_next$Types$equalDropTarget = F2(
		function (a, b) {
			...
			do {
				if (_p1.ctor === '_Tuple2') {
					switch (_p1._0.ctor) {
						case 'Before':
							if (_p1._1.ctor === 'Before') {
								return _elm_lang$core$Native_Utils.eq(_p1._0._0, _p1._1._0) && _elm_lang$core$Native_Utils.eq(_p1._0._1, _p1._1._1);
							} else {
								break _v1_3;
							}
						case 'After':
							if (_p1._1.ctor === 'After') {
								return _elm_lang$core$Native_Utils.eq(_p1._0._0, _p1._1._0) && _elm_lang$core$Native_Utils.eq(_p1._0._1, _p1._1._1);
							} else {
								break _v1_3;
							}
	...
	var _johannth$what_to_read_next$Types$AsanaAccessToken = F2(
		function (a, b) {
			return {name: a, token: b};
		});
	var _johannth$what_to_read_next$Types$AsanaProject = F2(
		function (a, b) {
			return {id: a, name: b};
		});
	var _johannth$what_to_read_next$Types$AsanaWorkspace = F2(
		function (a, b) {
			return {id: a, name: b};
		});
	var _johannth$what_to_read_next$Types$AsanaTask = F8(
		function (a, b, c, d, e, f, g, h) {
			return {id: a, url: b, assigneeStatus: c, projects: d, workspace: e, name: f, dueOn: g, completed: h};
		});
	var _johannth$what_to_read_next$Types$ExpandedState = F4(
		function (a, b, c, d) {
			return {$new: a, today: b, upcoming: c, later: d};
		});
	var _johannth$what_to_read_next$Types$DragTarget = F2(
		function (a, b) {
			return {assigneeStatus: a, targetId: b};
		});
	var _johannth$what_to_read_next$Types$TaskList = F4(
		function (a, b, c, d) {
			return {$new: a, today: b, upcoming: c, later: d};
		});
	var _johannth$what_to_read_next$Types$Model = function (a) {
		return function (b) {
			return function (c) {
				return function (d) {
					return function (e) {
											...
											return function (k) {
												return function (l) {
													return function (m) {
														return function (n) {
															return function (o) {
																return {apiHost: a, today: b, accessTokenFormExpanded: c, newAccessTokenName: d, newAccessTokenToken: e, accessTokens: f, tasks: g, taskList: h, workspaces: i, defaultWorkspace: j, buildInfo: k, dragDrop: l, expanded: m, datePickers: n, expandedAssigneeStatusOverlay: o};
															};
														};
													};
												};
	...
	var _johannth$what_to_read_next$Types$BuildInfo = F3(
		function (a, b, c) {
			return {version: a, time: b, tier: c};
		});
	var _johannth$what_to_read_next$Types$UpdateName = function (a) {
		return {ctor: 'UpdateName', _0: a};
	};
	var _johannth$what_to_read_next$Types$UpdateDueOn = function (a) {
		return {ctor: 'UpdateDueOn', _0: a};
	};
	var _johannth$what_to_read_next$Types$UpdateAssigneeStatus = function (a) {
		return {ctor: 'UpdateAssigneeStatus', _0: a};
	};
	var _johannth$what_to_read_next$Types$Complete = {ctor: 'Complete'};
	var _johannth$what_to_read_next$Types$Later = {ctor: 'Later'};
	...
	var _johannth$what_to_read_next$Types$End = function (a) {
		return {ctor: 'End', _0: a};
	};
	var _johannth$what_to_read_next$Types$After = F2(
		function (a, b) {
			return {ctor: 'After', _0: a, _1: b};
		});
	var _johannth$what_to_read_next$Types$Before = F2(
		function (a, b) {
			return {ctor: 'Before', _0: a, _1: b};
		});
	var _johannth$what_to_read_next$Types$SetDefaultWorkspace = function (a) {
		return {ctor: 'SetDefaultWorkspace', _0: a};
	};
	...
	var _johannth$what_to_read_next$Types$ReceiveItem = function (a) {
		return {ctor: 'ReceiveItem', _0: a};
	};
	var _johannth$what_to_read_next$Types$SaveAccessToken = {ctor: 'SaveAccessToken'};
	var _johannth$what_to_read_next$Types$AddAccessTokenToken = function (a) {
		return {ctor: 'AddAccessTokenToken', _0: a};
	};
	var _johannth$what_to_read_next$Types$AddAccessTokenName = function (a) {
		return {ctor: 'AddAccessTokenName', _0: a};
	};
	var _johannth$what_to_read_next$Types$ToggleAccessTokenForm = {ctor: 'ToggleAccessTokenForm'};
	var _johannth$what_to_read_next$Types$RemoveAccessToken = function (a) {
		return {ctor: 'RemoveAccessToken', _0: a};
	};
	var _johannth$what_to_read_next$Types$FocusResult = function (a) {
		return {ctor: 'FocusResult', _0: a};
	};
	var _johannth$what_to_read_next$Types$AddNewTask = F2(
		function (a, b) {
			return {ctor: 'AddNewTask', _0: a, _1: b};
		});
	...
	var _johannth$what_to_read_next$Types$CompleteTask = function (a) {
		return {ctor: 'CompleteTask', _0: a};
	};
	var _johannth$what_to_read_next$Types$ToggleExpanded = function (a) {
		return {ctor: 'ToggleExpanded', _0: a};
	};
	var _johannth$what_to_read_next$Types$TaskUpdated = function (a) {
		return {ctor: 'TaskUpdated', _0: a};
	};
	var _johannth$what_to_read_next$Types$TaskCreated = F2(
		function (a, b) {
			return {ctor: 'TaskCreated', _0: a, _1: b};
		});
	var _johannth$what_to_read_next$Types$LoadTasks = function (a) {
		return {ctor: 'LoadTasks', _0: a};
	};
	var _johannth$what_to_read_next$Types$DragDropMsg = function (a) {
		return {ctor: 'DragDropMsg', _0: a};
	};
	var _johannth$what_to_read_next$Types$UrlChange = function (a) {
	...
	var _johannth$what_to_read_next$Api$decodeTaskList = A5(
		_elm_lang$core$Json_Decode$map4,
		_johannth$what_to_read_next$Types$TaskList,
		A2(
			_elm_lang$core$Json_Decode$field,
			'new',
		...
		A2(
			...
			'later',
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
	var _johannth$what_to_read_next$Api$encodeTaskList = function (taskList) {
		var encodeStringList = function (_p0) {
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'new',
					_1: encodeStringList(taskList.$new)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'today',
						_1: encodeStringList(taskList.today)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'upcoming',
							_1: encodeStringList(taskList.upcoming)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'later',
								_1: encodeStringList(taskList.later)
							},
							_1: {ctor: '[]'}
						}
					}
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'assigneeStatus',
							_1: _johannth$what_to_read_next$Api$encodeAssigneeStatus(_p2._0)
						},
						_1: {ctor: '[]'}
					});
			case 'UpdateDueOn':
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$string(
								A3(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, _rluiten$elm_date_extra$Date_Extra_Format$isoDateFormat, _p2._0))
						},
						_1: {ctor: '[]'}
					});
			default:
	...
	var _johannth$what_to_read_next$Api$encodeAsanaTaskForCreation = function (task) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'name',
					_1: _elm_lang$core$Json_Encode$string(task.name)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'assigneeStatus',
						_1: _johannth$what_to_read_next$Api$encodeAssigneeStatus(task.assigneeStatus)
					},
					_1: {ctor: '[]'}
				}
			});
	...
	var _johannth$what_to_read_next$Api$decodeDueOn = A2(
		...
		function (maybeDateAsString) {
			var _p4 = maybeDateAsString;
			if (_p4.ctor === 'Just') {
				var _p5 = _elm_lang$core$Date$fromString(_p4._0);
				if (_p5.ctor === 'Ok') {
	...
	var _johannth$what_to_read_next$Api$decodeAsanaProject = A3(
		...
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
	var _johannth$what_to_read_next$Api$decodeAsanaTask = A9(
	...
	var _johannth$what_to_read_next$Api$decodeListOfTasks = _elm_lang$core$Json_Decode$list(_johannth$what_to_read_next$Api$decodeAsanaTask);
		...
		function (apiHost, accessTokens) {
			return A2(
				...
				A3(
					...
					A2(_elm_lang$core$Json_Decode$field, 'tasks', _johannth$what_to_read_next$Api$decodeListOfTasks)));
		});
	var _johannth$what_to_read_next$Api$createTask = F3(
		function (apiHost, accessTokens, task) {
			return A2(
				_elm_lang$http$Http$send,
				_johannth$what_to_read_next$Types$TaskCreated(task.id),
				A4(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_johannth$what_to_read_next$Api$apiUrl, apiHost, '/api/tasks/'),
						A2(_elm_lang$core$Basics_ops['++'], task.workspace.id, '/')),
					_elm_lang$http$Http$jsonBody(
						_johannth$what_to_read_next$Api$encodeAsanaTaskForCreation(task)),
					A2(_elm_lang$core$Json_Decode$field, 'task', _johannth$what_to_read_next$Api$decodeAsanaTask)));
		});
	...
	var _johannth$what_to_read_next$State$updateTaskList = F3(
		function (updater, assigneeStatus, taskList) {
			...
			switch (_p0.ctor) {
				case 'New':
					return _elm_lang$core$Native_Utils.update(
						taskList,
						{
							$new: updater(taskList.$new)
						});
				case 'Today':
					return _elm_lang$core$Native_Utils.update(
						taskList,
						{
							today: updater(taskList.today)
						});
				case 'Upcoming':
					return _elm_lang$core$Native_Utils.update(
						taskList,
						{
							upcoming: updater(taskList.upcoming)
						});
				default:
					return _elm_lang$core$Native_Utils.update(
						taskList,
						{
							later: updater(taskList.later)
						});
			}
		});
	var _johannth$what_to_read_next$State$insertIdIntoTaskList = F4(
		function (assigneeStatus, taskId, inserter, taskList) {
			return A3(
				_johannth$what_to_read_next$State$updateTaskList,
				inserter(taskId),
				assigneeStatus,
				taskList);
		});
	var _johannth$what_to_read_next$State$removeIdFromTaskList = F3(
		function (assigneeStatus, taskIdToRemove, taskList) {
			return A3(
				_johannth$what_to_read_next$State$updateTaskList,
				_elm_lang$core$List$filter(
					function (taskId) {
						return !_elm_lang$core$Native_Utils.eq(taskId, taskIdToRemove);
					}),
				assigneeStatus,
				taskList);
		});
	var _johannth$what_to_read_next$State$moveTaskInTaskList_ = F3(
		function (dragTarget, dropTarget, taskList) {
			var _p1 = function () {
				var _p2 = dropTarget;
				switch (_p2.ctor) {
					case 'Before':
						...
						return {
							...
							_2: F2(
								function (taskIdToInsert, taskIds) {
									var _p3 = taskIds;
									if (_p3.ctor === '[]') {
										return {
											ctor: '::',
										...
										return A2(
											...
											function (taskId) {
												return _elm_lang$core$Native_Utils.eq(taskId, _p4) ? {
													ctor: '::',
													_0: taskIdToInsert,
													_1: {
														ctor: '::',
								...
								function (taskIdToInsert, taskIds) {
									...
									if (_p5.ctor === '[]') {
										...
										return A2(
											_elm_lang$core$List$concatMap,
											function (taskId) {
												return _elm_lang$core$Native_Utils.eq(taskId, _p6) ? {
													ctor: '::',
													_0: taskId,
													_1: {
														ctor: '::',
			...
			var dropAssigneeStatus = _p1._0;
			var maybeDropTaskId = _p1._1;
			var inserter = _p1._2;
			return _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Maybe$Just(dragTarget.targetId),
				maybeDropTaskId) ? taskList : A4(
				_johannth$what_to_read_next$State$insertIdIntoTaskList,
				dropAssigneeStatus,
				dragTarget.targetId,
				inserter,
				A3(_johannth$what_to_read_next$State$removeIdFromTaskList, dragTarget.assigneeStatus, dragTarget.targetId, taskList));
		});
	var _johannth$what_to_read_next$State$moveTaskInTaskList = F3(
		function (dragTarget, dropTarget, maybeTaskList) {
			var _p7 = maybeTaskList;
			if (_p7.ctor === 'Just') {
				return _elm_lang$core$Maybe$Just(
					A3(_johannth$what_to_read_next$State$moveTaskInTaskList_, dragTarget, dropTarget, _p7._0));
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		});
	var _johannth$what_to_read_next$State$updateAssigneeStatus = F3(
		function (taskId, assigneeStatus, tasks) {
			var _p8 = A2(_elm_lang$core$Dict$get, taskId, tasks);
			if (_p8.ctor === 'Just') {
	...
	var _johannth$what_to_read_next$State$initDatePickers = function (tasks) {
		var everyThing = A2(
			...
			function (task) {
				...
				var _p10 = _elm_community$elm_datepicker$DatePicker$init(settings);
		...
		var datePickers = _elm_lang$core$Dict$fromList(
			A2(
				...
				function (_p11) {
					var _p12 = _p11;
					return {ctor: '_Tuple2', _0: _p12._0, _1: _p12._1};
				},
				everyThing));
		var effects = A2(
			_elm_lang$core$List$map,
	...
	var _johannth$what_to_read_next$State$saveTaskList = function (maybeTaskList) {
		var _p15 = maybeTaskList;
		if (_p15.ctor === 'Just') {
			return A3(_johannth$what_to_read_next$LocalStorage$setItem, _johannth$what_to_read_next$State$taskListStorageKey, _p15._0, _johannth$what_to_read_next$Api$encodeTaskList);
		} else {
	...
	var _johannth$what_to_read_next$State$init = F2(
		function (flags, location) {
			...
			var initialModel = {
				...
				taskList: _elm_lang$core$Maybe$Nothing,
				workspaces: _elm_lang$core$Dict$empty,
				defaultWorkspace: _elm_lang$core$Maybe$Nothing,
	...
	var _johannth$what_to_read_next$State$update = F2(
		function (msg, model) {
			...
			switch (_p16.ctor) {
				...
				case 'ReceiveItem':
					var _p20 = _p16._0;
					if (_elm_lang$core$Native_Utils.eq(_p20.key, _johannth$what_to_read_next$State$accessTokensStorageKey)) {
						var maybeAccessTokens = A2(_johannth$what_to_read_next$LocalStorage$decodeToType, _p20, _johannth$what_to_read_next$Api$decodeAccessTokens);
						var _p17 = maybeAccessTokens;
						if (_p17.ctor === 'Just') {
							var _p18 = _p17._0;
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								...
								{
									ctor: '::',
									_0: A2(_johannth$what_to_read_next$Api$getTasks, model.apiHost, _p18),
									_1: {ctor: '[]'}
								});
						} else {
							return A2(
						...
						if (_elm_lang$core$Native_Utils.eq(_p20.key, _johannth$what_to_read_next$State$defaultWorkspaceStorageKey)) {
							var maybeDefaultWorkspace = A2(_johannth$what_to_read_next$LocalStorage$decodeToType, _p20, _elm_lang$core$Json_Decode$string);
							var _p19 = maybeDefaultWorkspace;
							if (_p19.ctor === 'Just') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{defaultWorkspace: maybeDefaultWorkspace}),
									{ctor: '[]'});
							} else {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
							...
							if (_elm_lang$core$Native_Utils.eq(_p20.key, _johannth$what_to_read_next$State$taskListStorageKey)) {
								var taskList = A2(_johannth$what_to_read_next$LocalStorage$decodeToType, _p20, _johannth$what_to_read_next$Api$decodeTaskList);
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
					...
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							accessTokens: A2(
								_elm_lang$core$List$filter,
								function (token) {
									return !_elm_lang$core$Native_Utils.eq(token, _p16._0);
								},
								model.accessTokens)
						});
					return A2(
				...
				case 'LoadTasks':
					if (_p16._0.ctor === 'Err') {
						var x = A2(_elm_lang$core$Debug$log, 'Error', _p16._0._0);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{ctor: '[]'});
						...
						var currentTodayTasks = A2(
							...
							A2(
								...
								model.taskList));
						var currentTodayTasksLookUp = _elm_lang$core$Dict$fromList(
							A3(
								_elm_lang$core$List$map2,
								F2(
									function (v0, v1) {
								...
								A2(
									_elm_lang$core$List$range,
									0,
									_elm_lang$core$List$length(currentTodayTasks))));
						...
						var $new = A2(
							...
							A2(
								_elm_lang$core$List$filter,
								function (task) {
									return _elm_lang$core$Native_Utils.eq(task.assigneeStatus, _johannth$what_to_read_next$Types$New);
								},
						...
						var today = A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$List$filter,
									function (task) {
										return _elm_lang$core$Native_Utils.eq(task.assigneeStatus, _johannth$what_to_read_next$Types$Today);
									},
									_elm_lang$core$Dict$values(tasks))));
						var upcoming = A2(
							_elm_lang$core$List$map,
							...
							sortByDate(
								A2(
									_elm_lang$core$List$filter,
									function (task) {
										return _elm_lang$core$Native_Utils.eq(task.assigneeStatus, _johannth$what_to_read_next$Types$Upcoming);
									},
									_elm_lang$core$Dict$values(tasks))));
						var later = A2(
							_elm_lang$core$List$map,
							...
							sortByDate(
								A2(
									_elm_lang$core$List$filter,
									function (task) {
										return _elm_lang$core$Native_Utils.eq(task.assigneeStatus, _johannth$what_to_read_next$Types$Later);
									},
									_elm_lang$core$Dict$values(tasks))));
						var taskList = A4(_johannth$what_to_read_next$Types$TaskList, $new, today, upcoming, later);
						var workspaces = _elm_lang$core$Dict$fromList(
							A2(
								_elm_lang$core$List$map,
								function (task) {
									return {ctor: '_Tuple2', _0: task.workspace.id, _1: task.workspace};
								},
								_elm_lang$core$Dict$values(tasks)));
						var _p23 = _johannth$what_to_read_next$State$initDatePickers(
							_elm_lang$core$Dict$values(tasks));
						var datePickers = _p23._0;
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									taskList: _elm_lang$core$Maybe$Just(taskList),
									tasks: tasks,
				...
				case 'SetDefaultWorkspace':
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								defaultWorkspace: _elm_lang$core$Maybe$Just(_p24)
							}),
						{
							ctor: '::',
							_0: A3(_johannth$what_to_read_next$LocalStorage$setItem, _johannth$what_to_read_next$State$defaultWorkspaceStorageKey, _p24, _elm_lang$core$Json_Encode$string),
							_1: {ctor: '[]'}
						});
				case 'ToggleExpanded':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								expanded: A2(_johannth$what_to_read_next$State$toggleExpandedState, _p16._0, model.expanded)
							}),
						{ctor: '[]'});
				case 'CompleteTask':
					var _p25 = A2(_elm_lang$core$Dict$get, _p16._0, model.tasks);
					if (_p25.ctor === 'Just') {
						var _p26 = _p25._0;
						var updatedTask = _elm_lang$core$Native_Utils.update(
							_p26,
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									tasks: A3(_elm_lang$core$Dict$insert, updatedTask.id, updatedTask, model.tasks)
								}),
							{
								ctor: '::',
								_0: A4(_johannth$what_to_read_next$Api$updateTask, model.apiHost, model.accessTokens, _p26, _johannth$what_to_read_next$Types$Complete),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
				...
				case 'EditTaskName':
					var _p28 = _p16._0;
					var _p27 = A2(_elm_lang$core$Dict$get, _p28, model.tasks);
					if (_p27.ctor === 'Just') {
						var updatedTask = _elm_lang$core$Native_Utils.update(
							_p27._0,
							{name: _p16._1});
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									tasks: A3(_elm_lang$core$Dict$insert, _p28, updatedTask, model.tasks)
								}),
							{ctor: '[]'});
					} else {
						return A2(
				...
				case 'StopEditTaskName':
					var _p29 = A2(_elm_lang$core$Dict$get, _p16._0, model.tasks);
					if (_p29.ctor === 'Just') {
						var _p30 = _p29._0;
						var command = A2(_elm_lang$core$String$startsWith, 'local-', _p30.id) ? A3(_johannth$what_to_read_next$Api$createTask, model.apiHost, model.accessTokens, _p30) : A4(
							_johannth$what_to_read_next$Api$updateTask,
							model.apiHost,
							model.accessTokens,
							_p30,
							_johannth$what_to_read_next$Types$UpdateName(_p30.name));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{
				...
				case 'AddNewTask':
					...
					var _p31 = A2(
						...
						function (workspaceId) {
							return A2(_elm_lang$core$Dict$get, workspaceId, model.workspaces);
						},
						model.defaultWorkspace);
					if (_p31.ctor === 'Just') {
						var _p32 = _elm_community$elm_datepicker$DatePicker$init(_elm_community$elm_datepicker$DatePicker$defaultSettings);
						var datePicker = _p32._0;
						var datePickerFx = _p32._1;
						var localId = A2(
							_elm_lang$core$Basics_ops['++'],
							'local-',
							_elm_lang$core$Basics$toString(
						...
						var task = A8(
							...
							false);
						var taskList = A3(
							_johannth$what_to_read_next$State$moveTaskInTaskList,
							A2(_johannth$what_to_read_next$Types$DragTarget, task.assigneeStatus, task.id),
							A2(_johannth$what_to_read_next$Types$After, _p33, _p16._1),
							model.taskList);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
				...
				case 'ToDatePicker':
					...
					var _p34 = {
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Dict$get, _p40, model.datePickers),
						_1: A2(_elm_lang$core$Dict$get, _p40, model.tasks)
					};
					if (((_p34.ctor === '_Tuple2') && (_p34._0.ctor === 'Just')) && (_p34._1.ctor === 'Just')) {
						var _p39 = _p34._1._0;
						var _p35 = A2(_elm_community$elm_datepicker$DatePicker$update, _p16._1, _p34._0._0);
						var newDatePicker = _p35._0;
						var datePickerFx = _p35._1;
						var maybeDate = _p35._2;
						var datePickers = A3(_elm_lang$core$Dict$insert, _p40, newDatePicker, model.datePickers);
						var _p36 = function () {
							var _p37 = maybeDate;
							if (_p37.ctor === 'Just') {
								var _p38 = _p37._0;
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										_p39,
										{
											dueOn: _elm_lang$core$Maybe$Just(_p38)
										}),
									_1: A4(
										_johannth$what_to_read_next$Api$updateTask,
										model.apiHost,
										model.accessTokens,
										_p39,
										_johannth$what_to_read_next$Types$UpdateDueOn(_p38))
								};
							} else {
								return {ctor: '_Tuple2', _0: _p39, _1: _elm_lang$core$Platform_Cmd$none};
							}
						}();
						var updatedTask = _p36._0;
						var command = _p36._1;
						var tasks = A3(_elm_lang$core$Dict$insert, _p40, updatedTask, model.tasks);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{datePickers: datePickers, tasks: tasks}),
							{
								...
								_0: A2(
									_elm_lang$core$Platform_Cmd$map,
									_johannth$what_to_read_next$Types$ToDatePicker(_p40),
									datePickerFx),
								_1: {
									ctor: '::',
									_0: command,
				...
				case 'TaskCreated':
					if (_p16._1.ctor === 'Err') {
						...
						var datePickers = function () {
							var _p41 = A2(_elm_lang$core$Dict$get, _p42, model.datePickers);
							if (_p41.ctor === 'Just') {
								return A3(
									_elm_lang$core$Dict$insert,
									_p43.id,
									_p41._0,
									A2(_elm_lang$core$Dict$remove, _p42, model.datePickers));
							} else {
								return model.datePickers;
							}
						}();
						var taskList = A2(
							_elm_lang$core$Maybe$map,
							A2(
								...
								_elm_lang$core$List$map(
									function (taskId) {
										return _elm_lang$core$Native_Utils.eq(taskId, _p42) ? _p43.id : taskId;
									}),
								_p43.assigneeStatus),
							model.taskList);
						var tasks = A3(_elm_lang$core$Dict$insert, _p43.id, _p43, model.tasks);
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{tasks: tasks, taskList: taskList, datePickers: datePickers});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
							{
								ctor: '::',
								_0: _johannth$what_to_read_next$State$saveTaskList(updatedModel.taskList),
								_1: {ctor: '[]'}
							});
					}
				case 'TaskUpdated':
					return A2(
						...
						{ctor: '[]'});
				case 'DragDropMsg':
					var _p44 = A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$update, _p16._0, model.dragDrop);
					var dragDrop = _p44._0;
					var result = _p44._1;
					var _p45 = function () {
						var _p46 = result;
						if (_p46.ctor === 'Just') {
							var _p49 = _p46._0._1;
							var _p48 = _p46._0._0;
							var newAssigneeStatus = _johannth$what_to_read_next$Types$assigneeStatusFromDropTarget(_p49);
							var _p47 = A2(_elm_lang$core$Dict$get, _p48.targetId, model.tasks);
							if (_p47.ctor === 'Just') {
								return {
									ctor: '_Tuple3',
									_0: A3(_johannth$what_to_read_next$State$moveTaskInTaskList, _p48, _p49, model.taskList),
									_1: A3(_johannth$what_to_read_next$State$updateAssigneeStatus, _p48.targetId, newAssigneeStatus, model.tasks),
									_2: {
										ctor: '::',
										_0: A4(
											_johannth$what_to_read_next$Api$updateTask,
											...
											model.accessTokens,
											_p47._0,
											_johannth$what_to_read_next$Types$UpdateAssigneeStatus(newAssigneeStatus)),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					var taskList = _p45._0;
					var tasks = _p45._1;
					var commands = _p45._2;
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{dragDrop: dragDrop, taskList: taskList, tasks: tasks});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								expandedAssigneeStatusOverlay: _elm_lang$core$Native_Utils.eq(
									...
									_elm_lang$core$Maybe$Just(_p50)) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p50)
							}),
						{ctor: '[]'});
				default:
					var _p54 = _p16._0;
					var _p53 = _p16._1;
					var _p51 = A2(_elm_lang$core$Dict$get, _p54, model.tasks);
					if (_p51.ctor === 'Just') {
						var _p52 = _p51._0;
						var taskList = A3(
							_johannth$what_to_read_next$State$moveTaskInTaskList,
							A2(_johannth$what_to_read_next$Types$DragTarget, _p52.assigneeStatus, _p52.id),
							_johannth$what_to_read_next$Types$End(_p53),
							model.taskList);
						var updatedTask = _elm_lang$core$Native_Utils.update(
							_p52,
							{assigneeStatus: _p53});
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								tasks: A3(_elm_lang$core$Dict$insert, _p54, updatedTask, model.tasks),
								taskList: taskList,
								expandedAssigneeStatusOverlay: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							...
							updatedModel,
							{
								...
								_0: A4(
									...
									model.accessTokens,
									_p52,
									_johannth$what_to_read_next$Types$UpdateAssigneeStatus(_p53)),
								_1: {
									ctor: '::',
									_0: _johannth$what_to_read_next$State$saveTaskList(updatedModel.taskList),
									_1: {ctor: '[]'}
	...
	var _johannth$what_to_read_next$View$onEnterPress = function (tagger) {
		return A2(
			...
			A2(
				_elm_lang$core$Json_Decode$map,
				function (keyCode) {
					return _elm_lang$core$Native_Utils.eq(keyCode, 13) ? tagger : _johannth$what_to_read_next$Types$Void;
				},
	...
	var _johannth$what_to_read_next$View$taskDatePickerView = F4(
		function (today, datePicker, taskId, maybeDueDate) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('datePickerContainer'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							_johannth$what_to_read_next$Types$ToDatePicker(taskId),
							_elm_community$elm_datepicker$DatePicker$view(datePicker)),
						_1: {ctor: '[]'}
					}
				});
		});
	var _johannth$what_to_read_next$View$taskTitleView = F3(
		function (taskId, assigneeStatus, title) {
			return A2(
				_elm_lang$html$Html$input,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('taskTitle'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id(
							_johannth$what_to_read_next$State$titleInputId(taskId)),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _johannth$what_to_read_next$View$onEnterPress(
										A2(_johannth$what_to_read_next$Types$AddNewTask, assigneeStatus, taskId)),
									_1: {
										ctor: '::',
	...
	var _johannth$what_to_read_next$View$checkMark = A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$points('27.672,4.786 10.901,21.557 4.328,14.984 1.5,17.812 10.901,27.214 30.5,7.615 '),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
		});
	var _johannth$what_to_read_next$View$taskCompletionButton = function (taskId) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('taskCompletionButton'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_johannth$what_to_read_next$Types$CompleteTask(taskId)),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _johannth$what_to_read_next$View$checkMark,
				_1: {ctor: '[]'}
			});
	};
	var _johannth$what_to_read_next$View$dragHandle = A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 32 32'),
	...
	var _johannth$what_to_read_next$View$classNameIfOnTop = F2(
		function (maybeCurrentDropTarget, dropTarget) {
			var _p2 = maybeCurrentDropTarget;
			if (_p2.ctor === 'Just') {
				return A2(_johannth$what_to_read_next$Types$equalDropTarget, _p2._0, dropTarget) ? 'onTop' : '';
			} else {
				return '';
			}
		});
	var _johannth$what_to_read_next$View$taskView = F5(
		function (today, assigneeStatusViewIsExpanded, datePicker, currentDropTarget, task) {
			var isHeading = A2(_elm_lang$core$String$endsWith, ':', task.name);
			var dropTarget = A2(_johannth$what_to_read_next$Types$Before, task.assigneeStatus, task.id);
			var classNames = A2(
				_elm_lang$core$Basics_ops['++'],
				'task ',
				A2(_johannth$what_to_read_next$View$classNameIfOnTop, currentDropTarget, dropTarget));
			return A2(
				_elm_lang$html$Html$li,
				A2(
					_elm_lang$core$Basics_ops['++'],
					...
					A2(
						...
						A2(
							...
							_johannth$what_to_read_next$Types$DragDropMsg,
							A2(_johannth$what_to_read_next$Types$DragTarget, task.assigneeStatus, task.id)),
						A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$droppable, _johannth$what_to_read_next$Types$DragDropMsg, dropTarget))),
				isHeading ? {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('taskTitleAsHeader'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
	...
	var _johannth$what_to_read_next$View$triangle = A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 32 32'),
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$d('M7.207,13.707L16.5,23l9.293-9.293c0.63-0.63,0.184-1.707-0.707-1.707H7.914C7.023,12,6.577,13.077,7.207,13.707z'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
		});
	var _johannth$what_to_read_next$View$taskListHeaderView = F3(
		function (assigneeStatus, title, expanded) {
			return A2(
				_elm_lang$html$Html$h2,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('tasksHeader'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_johannth$what_to_read_next$Types$ToggleExpanded(assigneeStatus)),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _johannth$what_to_read_next$View$triangle,
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
	...
	var _johannth$what_to_read_next$View$taskListSegmentView = F6(
		function (config, today, expandedAssigneeStatusOverlay, tasks, currentDropTarget, expanded) {
			var dropView = A2(
				_johannth$what_to_read_next$View$fakeDropView,
				currentDropTarget,
				_johannth$what_to_read_next$Types$End(config.assigneeStatus));
			var hasExpandedAssigneeStatusOverlay = function (task) {
				return _elm_lang$core$Native_Utils.eq(
					_elm_lang$core$Maybe$Just(task.id),
					expandedAssigneeStatusOverlay);
			};
			var taskViews = expanded ? A2(
				_elm_lang$core$List$map,
				function (_p3) {
					var _p4 = _p3;
					var _p5 = _p4._0;
					return A5(
						...
						today,
						hasExpandedAssigneeStatusOverlay(_p5),
						_p4._1,
						currentDropTarget,
						_p5);
				},
				A2(
					...
					function (_p6) {
						var _p7 = _p6;
						return !_p7._0.completed;
					},
					tasks)) : {ctor: '[]'};
			return (config.hideOnEmpty && _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$List$length(tasks),
				0)) ? _elm_lang$html$Html$text('') : A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: A3(_johannth$what_to_read_next$View$taskListHeaderView, config.assigneeStatus, config.title, expanded),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$ul,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('tasks'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$Basics_ops['++'],
	...
	var _johannth$what_to_read_next$View$filterTasksByStatus = F2(
		function (assigneeStatus, tasks) {
			return A2(
				_elm_lang$core$List$map,
				function (_p8) {
					var _p9 = _p8;
					return {ctor: '_Tuple3', _0: _p9._0, _1: _p9._2, _2: _p9._3};
				},
				A2(
					_elm_lang$core$List$filter,
					function (_p10) {
						var _p11 = _p10;
						return _elm_lang$core$Native_Utils.eq(_p11._1, assigneeStatus);
					},
					tasks));
		});
	var _johannth$what_to_read_next$View$workspaceView = F2(
		function (maybeDefaultWorkspace, workspace) {
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_johannth$what_to_read_next$Types$SetDefaultWorkspace(workspace.id)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(
							A2(
								...
								_elm_lang$core$Native_Utils.eq(
									...
									_elm_lang$core$Maybe$Just(workspace.id)) ? ' default' : '')),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(workspace.name),
					_1: {ctor: '[]'}
				});
		});
	var _johannth$what_to_read_next$View$accessTokenView = function (accessToken) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('accessToken'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('accessTokenName'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(accessToken.name),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('removeAccessToken'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_johannth$what_to_read_next$Types$RemoveAccessToken(accessToken)),
								_1: {ctor: '[]'}
							}
						},
						{
	...
	var _johannth$what_to_read_next$View$toggleAccessTokenButtonView = A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('expandAccessTokenForm'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_johannth$what_to_read_next$Types$ToggleAccessTokenForm),
				_1: {ctor: '[]'}
			}
		},
		{
	...
	var _johannth$what_to_read_next$View$addNewAccessTokenView = function (expanded) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('newAccessToken'),
				_1: {ctor: '[]'}
			},
			expanded ? {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('newAccessTokenInput'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Name'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_johannth$what_to_read_next$Types$AddAccessTokenName),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$placeholder('Access token'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_johannth$what_to_read_next$Types$AddAccessTokenToken),
									_1: {
										ctor: '::',
										_0: _johannth$what_to_read_next$View$onEnterPress(_johannth$what_to_read_next$Types$SaveAccessToken),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				ctor: '::',
				_0: _johannth$what_to_read_next$View$toggleAccessTokenButtonView,
				_1: {ctor: '[]'}
			});
	};
	var _johannth$what_to_read_next$View$tokensView = F2(
		function (accessTokenFormExpanded, accessTokens) {
			var expanded = accessTokenFormExpanded || _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$List$length(accessTokens),
				0);
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('accessTokens'),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$List$map, _johannth$what_to_read_next$View$accessTokenView, accessTokens),
					{
						ctor: '::',
						_0: _johannth$what_to_read_next$View$addNewAccessTokenView(expanded),
						_1: {ctor: '[]'}
					}));
		});
	var _johannth$what_to_read_next$View$expandTasks = F3(
		function (allTasks, datePickers, taskList) {
			return A2(
				...
				function (taskId) {
					var _p12 = {
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Dict$get, taskId, allTasks),
						_1: A2(_elm_lang$core$Dict$get, taskId, datePickers)
					};
					if (((_p12.ctor === '_Tuple2') && (_p12._0.ctor === 'Just')) && (_p12._1.ctor === 'Just')) {
						return _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple2', _0: _p12._0._0, _1: _p12._1._0});
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				},
	...
	var _johannth$what_to_read_next$View$taskListView = function (_p13) {
		var _p14 = _p13;
		var _p21 = _p14.today;
		var _p20 = _p14.tasks;
		var _p19 = _p14.expandedAssigneeStatusOverlay;
		var _p18 = _p14.expanded;
		var _p17 = _p14.datePickers;
		var _p15 = _p14.taskList;
		if (_p15.ctor === 'Just') {
			var _p16 = _p15._0;
			var laterTasks = A3(_johannth$what_to_read_next$View$expandTasks, _p20, _p17, _p16.later);
			var upcomingTasks = A3(_johannth$what_to_read_next$View$expandTasks, _p20, _p17, _p16.upcoming);
			var todayTasks = A3(_johannth$what_to_read_next$View$expandTasks, _p20, _p17, _p16.today);
			var newTasks = A3(_johannth$what_to_read_next$View$expandTasks, _p20, _p17, _p16.$new);
			var currentDropTarget = _norpan$elm_html5_drag_drop$Html5_DragDrop$getDropId(_p14.dragDrop);
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: A6(
						_johannth$what_to_read_next$View$taskListSegmentView,
						{assigneeStatus: _johannth$what_to_read_next$Types$New, title: 'New', hideOnEmpty: true},
						_p21,
						_p19,
						newTasks,
						currentDropTarget,
					...
					_1: {
						...
						_0: A6(
							_johannth$what_to_read_next$View$taskListSegmentView,
							{assigneeStatus: _johannth$what_to_read_next$Types$Today, title: 'Today', hideOnEmpty: false},
							_p21,
							_p19,
							todayTasks,
							currentDropTarget,
						...
						_1: {
							...
							_0: A6(
								_johannth$what_to_read_next$View$taskListSegmentView,
								{assigneeStatus: _johannth$what_to_read_next$Types$Upcoming, title: 'Upcoming', hideOnEmpty: false},
								_p21,
								_p19,
								upcomingTasks,
								currentDropTarget,
							...
							_1: {
								...
								_0: A6(
									_johannth$what_to_read_next$View$taskListSegmentView,
									{assigneeStatus: _johannth$what_to_read_next$Types$Later, title: 'Later', hideOnEmpty: false},
									_p21,
									_p19,
									laterTasks,
									currentDropTarget,
	...
	var _johannth$what_to_read_next$View$tasksView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('workspaces'),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$List$map,
						_johannth$what_to_read_next$View$workspaceView(model.defaultWorkspace),
						_elm_lang$core$Dict$values(model.workspaces))),
				_1: {
					ctor: '::',
					_0: _johannth$what_to_read_next$View$taskListView(model),
					_1: {ctor: '[]'}
				}
			});
	};
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Asana Inbox'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_johannth$what_to_read_next$View$tokensView, model.accessTokenFormExpanded, model.accessTokens),
							_1: {
								ctor: '::',
								_0: hasNoTasks ? (isLoading ? A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									{
										ctor: '::',
									...
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									{ctor: '[]'})) : _johannth$what_to_read_next$View$tasksView(model),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _johannth$what_to_read_next$View$buildInfoView(model.buildInfo),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
	...
	var _johannth$what_to_read_next$View$TaskListSegmentConfig = F3(
		function (a, b, c) {
			return {assigneeStatus: a, title: b, hideOnEmpty: c};
		});
	
	var _johannth$what_to_read_next$Subscriptions$subscriptions = function (_p0) {
		return _johannth$what_to_read_next$LocalStorage$receiveItem(_johannth$what_to_read_next$Types$ReceiveItem);
	};
	
	var _johannth$what_to_read_next$Main$main = A2(
		_elm_lang$navigation$Navigation$programWithFlags,
		_johannth$what_to_read_next$Types$UrlChange,
		{init: _johannth$what_to_read_next$State$init, view: _johannth$what_to_read_next$View$rootView, update: _johannth$what_to_read_next$State$update, subscriptions: _johannth$what_to_read_next$Subscriptions$subscriptions})(
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (apiHost) {
				return A2(
					...
					function (buildTier) {
						return A2(
							...
							A2(_elm_lang$core$Json_Decode$field, 'buildTime', _elm_lang$core$Json_Decode$string));
					},
					A2(_elm_lang$core$Json_Decode$field, 'buildTier', _elm_lang$core$Json_Decode$string));
			},
			A2(_elm_lang$core$Json_Decode$field, 'apiHost', _elm_lang$core$Json_Decode$string)));
	
	var Elm = {};
	Elm['Main'] = Elm['Main'] || {};
	if (typeof _johannth$what_to_read_next$Main$main !== 'undefined') {
	    _johannth$what_to_read_next$Main$main(Elm['Main'], 'Main', undefined);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = Elm.Main.embed(mountNode, {
	  today: Date.now(),
	  buildVersion: ("446879094014bc7e1b371c73b5f1846b998d4a3a\n"),
	  buildTime: ("2017-04-25T22:29:25.128Z"),
